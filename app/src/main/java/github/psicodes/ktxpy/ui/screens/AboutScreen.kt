...
fun AboutScreen(){
    Scaffold(
        ...
        Column(
            ...
            Divider()
            Text(modifier = Modifier.padding(12.dp), text = "Developer = 伏秋洛", fontSize = 14.sp, fontFamily = FontFamily(Font(R.font.roboto_condensed_bold)))
            Text(modifier = Modifier.padding(12.dp), text = "CxKitty Author = SocialSisterYi", fontSize = 14.sp, fontFamily = FontFamily(Font(R.font.roboto_condensed_bold)))
            Divider()
            ...
            Text(modifier = Modifier.padding(20.dp),text = "用于在移动设备平台运行CxKitty进行学习与交流分析。", fontSize = 12.sp, fontFamily = FontFamily(Font(R.font.custom_sans)))
            ...
            Divider(modifier = Modifier.padding(12.dp))
            Text(text = "Special Thanks To Rosmoe ,Termux team & hzy3774, CxKitty & SocialSisterYi", fontSize = 13.sp, fontFamily = FontFamily(Font(R.font.roboto_condensed_bold)), modifier = Modifier.padding(12.dp,6.dp,2.dp,6.dp))
            Divider(modifier = Modifier.padding(12.dp))
        }
    }
}
