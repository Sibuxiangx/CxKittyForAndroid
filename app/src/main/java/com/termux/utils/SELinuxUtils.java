...
public class SELinuxUtils {
    ...
    public static String getContext() {
        ...
        try {
            ...
            if (method == null) {
                Log.d(LOG_TAG, "Failed to get " + methodName + "() method of " + ANDROID_OS_SELINUX_CLASS + " class");
                return null;
            }

            return (String) ReflectionUtils.invokeMethod(method, null).value;
        } catch (Exception e) {
            Log.d(LOG_TAG, "Failed to call " + methodName + "() method of " + ANDROID_OS_SELINUX_CLASS + " class", e);
            return null;
        }
    }
